    ...
    <div class="container py-12 py-md-16 text-center">
      <div class="row">
        <div class="col-md-7 col-lg-6 col-xl-5 mx-auto">
          ...
          <p class="lead px-lg-5 px-xxl-8 mb-1">Anda dapat melihat berita terbaru di sini</p>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-8">
          <div class="blog classic-view">
            @foreach ($data as $key => $row)
              <article class="post">
                <div class="card">
                  <figure class="card-img-top overlay overlay-1 hover-scale"><a href="/berita/{{ $row->getKey() }}"><img
                  ...
                  <div class="card-body">
                    <div class="post-header">
                      ...
                      <h2 class="post-title mt-1 mb-0"><a class="link-dark"
                          href="/berita/{{ $row->getKey() }}">{{ $row->judul }}</a></h2>
                    </div>
                    <!-- /.post-header -->
          ...
          <div class="widget">
            ...
            <ul class="unordered-list bullet-primary text-reset">
              @foreach ($dataArsip as $row)
                <li><a
                    href="/berita?arsip={{ $row->tanggal }}">{{ \Carbon\Carbon::parse($row->tanggal)->format('F Y') }}</a>
                </li>
              @endforeach
            </ul>
          </div>
