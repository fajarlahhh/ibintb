                    ...
                    <div class="card-header form-inline">
                        <div class="row w-100">
                            <div class="col-md-4 col-lg-4 col-xl-4 col-xs-12">
                                <a href="/admin-area/agenda/tambah" class="btn btn-primary">Tambah</a>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group btn-group-sm" role="group">
                                                @if ($status == 2)
                                                    @if ($key === $row->getKey())
                                                        <button wire:click="restore()" class="btn btn-success">Ya,
                                                            Restore</button>
                                                ...
                                                @else
                                                    @if ($key === $row->getKey())
                                                        <button wire:click="hapus" class="btn btn-warning">Ya,
                                                            Hapus</button>
                                                        <button wire:click="hapusPermanen" class="btn btn-danger">Ya,
                                                            Hapus Permanen</button>
                                                        <button wire:click="setKey"
                                                            class="btn btn-success">Batal</button>
                                                    @else
                                                        <a href="/admin-area/agenda/edit/{{ $row->getKey() }}"
