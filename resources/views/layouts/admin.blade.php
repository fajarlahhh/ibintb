          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="/admin-area/datakategori" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Data Kategori</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="/admin-area/pengguna" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Pengguna</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              <a href="/admin-area/databerita" class="nav-link">
            ...
            <li class="nav-item">
              <a href="/admin-area/datakegiatan" class="nav-link">
