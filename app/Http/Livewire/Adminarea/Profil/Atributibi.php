...
class Atributibi extends Component
{
  public $isi, $data;
  ...
  {
    $this->data = Profil::where('jenis', 'atributibi')->get();
  ...
  {
    return view('livewire.adminarea.profil.atributibi')
